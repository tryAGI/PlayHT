...
namespace PlayHT
{
    public partial class TextToSpeechClient
    {
        ...
        private static readonly global::PlayHT.EndPointSecurityRequirement s_GetSpeechJobSecurityRequirement0 =
        ...
        private static readonly global::PlayHT.EndPointSecurityRequirement[] s_GetSpeechJobSecurityRequirements =
            new global::PlayHT.EndPointSecurityRequirement[]
            {                s_GetSpeechJobSecurityRequirement0,
            };
        partial void PrepareGetSpeechJobArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string asyncTtsJobId);
        partial void PrepareGetSpeechJobRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string asyncTtsJobId);
        partial void ProcessGetSpeechJobResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSpeechJobResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PlayHT.SpeechJob> GetSpeechJobAsync(
            string asyncTtsJobId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PlayHT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PlayHT.AutoSDKHttpResponse<global::PlayHT.SpeechJob>> GetSpeechJobAsResponseAsync(
            string asyncTtsJobId,
            global::PlayHT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSpeechJobArguments(
                httpClient: HttpClient,
                asyncTtsJobId: ref asyncTtsJobId);


            var __authorizations = global::PlayHT.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetSpeechJobSecurityRequirements,
                operationName: "GetSpeechJobAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PlayHT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PlayHT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSpeechJobAsync",
                                pathTemplate: "$\"/api/v1/tts/{asyncTtsJobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::PlayHT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::PlayHT.ErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::PlayHT.ErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSpeechJobResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::PlayHT.AutoSDKHttpResponse<global::PlayHT.SpeechJob>(
                                        statusCode: __response.StatusCode,

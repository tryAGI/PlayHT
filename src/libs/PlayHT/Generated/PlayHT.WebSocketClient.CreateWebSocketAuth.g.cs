...
namespace PlayHT
{
    public partial class WebSocketClient
    {
        ...
        private static readonly global::PlayHT.EndPointSecurityRequirement s_CreateWebSocketAuthSecurityRequirement0 =
        ...
        private static readonly global::PlayHT.EndPointSecurityRequirement[] s_CreateWebSocketAuthSecurityRequirements =
            new global::PlayHT.EndPointSecurityRequirement[]
            {                s_CreateWebSocketAuthSecurityRequirement0,
            };
        partial void PrepareCreateWebSocketAuthArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCreateWebSocketAuthRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCreateWebSocketAuthResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWebSocketAuthResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PlayHT.WebSocketAuthResponse> CreateWebSocketAuthAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PlayHT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PlayHT.AutoSDKHttpResponse<global::PlayHT.WebSocketAuthResponse>> CreateWebSocketAuthAsResponseAsync(
            global::PlayHT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWebSocketAuthArguments(
                httpClient: HttpClient);


            var __authorizations = global::PlayHT.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CreateWebSocketAuthSecurityRequirements,
                operationName: "CreateWebSocketAuthAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateWebSocketAuthRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PlayHT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PlayHT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateWebSocketAuth",
                                methodName: "CreateWebSocketAuthAsync",
                                pathTemplate: "\"/api/v1/tts/websocket-auth\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateWebSocketAuthResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PlayHT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateWebSocketAuthResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::PlayHT.AutoSDKHttpResponse<global::PlayHT.WebSocketAuthResponse>(

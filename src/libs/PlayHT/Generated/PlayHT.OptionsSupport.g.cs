...
namespace PlayHT
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::PlayHT.AutoSDKRetryOptions Retry { get; set; } = new global::PlayHT.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::PlayHT.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::PlayHT.IAutoSDKHook>();
        ...
        public global::PlayHT.AutoSDKClientOptions AddHook(
            global::PlayHT.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::PlayHT.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::PlayHT.AutoSDKClientOptions UseAuthorizationProvider(
            global::PlayHT.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::PlayHT.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::PlayHT.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::PlayHT.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::PlayHT.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::PlayHT.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::PlayHT.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::PlayHT.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::PlayHT.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::PlayHT.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::PlayHT.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::PlayHT.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::PlayHT.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::PlayHT.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::PlayHT.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::PlayHT.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::PlayHT.AutoSDKClientOptions clientOptions,
            global::System.Func<global::PlayHT.IAutoSDKHook, global::PlayHT.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::PlayHT.AutoSDKHookContext context)
        {

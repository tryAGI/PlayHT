...
{
    /// <inheritdoc />
    public sealed class OutputFormatJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::PlayHT.OutputFormat>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::PlayHT.OutputFormatExtensions.ToValueString(value));
        }
    }
}

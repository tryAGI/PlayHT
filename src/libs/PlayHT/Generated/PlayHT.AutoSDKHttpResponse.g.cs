...
namespace PlayHT
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::PlayHT.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::PlayHT.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::PlayHT.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::PlayHT.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::PlayHT.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::PlayHT.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::PlayHT.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::PlayHT.ApiException exception)
        ...
        private static global::PlayHT.AutoSDKRequestOptions CloneRequestOptions(
            global::PlayHT.AutoSDKRequestOptions? source)
        {
            var clone = new global::PlayHT.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }

...
The PlayHT SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package PlayHT
```
...
using var client = new PlayHTClient(
    apiKey: Environment.GetEnvironmentVariable("PLAYHT_API_KEY")!,
    userId: Environment.GetEnvironmentVariable("PLAYHT_USER_ID")!);

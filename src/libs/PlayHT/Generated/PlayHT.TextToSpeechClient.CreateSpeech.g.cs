...
namespace PlayHT
{
    public partial class TextToSpeechClient
    {
        ...
        private static readonly global::PlayHT.EndPointSecurityRequirement s_CreateSpeechSecurityRequirement0 =
        ...
        private static readonly global::PlayHT.EndPointSecurityRequirement[] s_CreateSpeechSecurityRequirements =
            new global::PlayHT.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::PlayHT.CreateSpeechResponse> CreateSpeechAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PlayHT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PlayHT.AutoSDKHttpResponse<global::PlayHT.CreateSpeechResponse>> CreateSpeechAsResponseAsync(
                    ...
                    await global::PlayHT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::PlayHT.AutoSDKHttpResponse<global::PlayHT.CreateSpeechResponse>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::PlayHT.CreateSpeechResponse> CreateSpeechAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PlayHT.CreateSpeechRequest
            {
                Text = text,
                Voice = voice,
                Model = model,
